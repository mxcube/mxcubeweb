...
The underlaying beamline control layer is implemented using the library [mxcubecore](https://github.com/mxcube/mxcubecore) previously known as [HardwareRepository](https://github.com/mxcube/HardwareRepository). The mxcubecore module is compatable with both MXCubE3 also known as MXCuBE-Web and the [MXCuBE-Qt application](https://github.com/mxcube/mxcubeqt). The earlier versions of MXCuBE3 (upto 3.2.x) uses [HardwareRepository](https://github.com/mxcube/HardwareRepository)
