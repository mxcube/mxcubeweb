...
export default function SampleListViewContainer(props) {
  ...
  const handleSetViewMode = useCallback(
    (mode) => {
      if (type.includes('FLEX') && mode.includes('Graphical')) {
  ...
  }, [handleSetViewMode, viewMode.mode]); // Dependencies
  ...
  //   dispatch(selectSamplesAction(Object.keys(sampleList)));
  // }
  ...
  //   selectSamples(Object.keys(sampleList), false);
  // }
