...
class DataCollectionTest extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <DraggableModal show={this.props.show} onHide={this.props.hide}>
        <Modal.Header closeButton>
          <Modal.Title>Test Data Collection</Modal.Title>
        </Modal.Header>
        <Modal.Body >
          <Form>
...
DataCollectionTest = connect((state) => {
