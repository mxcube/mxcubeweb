...
export default class PeriodicTable extends React.Component {
  ...
  onClickHandler(e) {
    if (e.target.id) {
      ...
      if (el) {
        el.children[0].className = 'element';
      }
