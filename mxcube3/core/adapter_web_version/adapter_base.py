...
class AdapterBase:
    ...
    def attributes(self):
        # print("进入adapter_base.py中的attributes()")
        _attributes = {}

        for attribute_name in self.ATTRIBUTES:
            attr = getattr(self, attribute_name, None)
            # print("adapter_base.py中的attributes()的attr:",attr)
            if attr:
                model = self._model_from_typehint(attr)
                value = attr()
        ...
        print("结束adapter_base.py中的attributes()")
        return _attributes
    ...
    def _dict_repr(self):
        ...
        """
        try:
            print("adapter_base.py中self._name:",self._name)
            data = {
                "name": self._name,
                "state": self.state(),
                "msg": self.msg(),
