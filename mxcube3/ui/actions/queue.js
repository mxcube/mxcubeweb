...
export function addSample(sample_id, queue_id) {
  return {
    type: 'ADD_SAMPLE', sample_id, queue_id
  };
}

export function removeSample(queue_id, sample_id) {
  return {
    type: 'REMOVE_SAMPLE', queue_id, sample_id
  };
}
