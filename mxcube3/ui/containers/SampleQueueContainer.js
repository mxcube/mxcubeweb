...
class SampleQueueContainer extends Component {
  ...
  render() {
    ...
    const {toggleCheckBox, sendChangeOrder, sendDeleteSample, finishSample, runSample,mountSample, selectSample} = this.props.queueActions;
    ...
    return (
      ...
      <div className="row">
            <div className="col-xs-12 queue">
                ...
                <TodoTree showForm={showForm} todoList={todo} sampleInformation={sampleInformation} queue={queue} lookup={lookup} toggleCheckBox={toggleCheckBox} checked={checked} select={selectSample} deleteSample={sendDeleteSample} deleteMethod={sendDeleteSampleMethod} mount={mountSample} searchString={searchString}/>
