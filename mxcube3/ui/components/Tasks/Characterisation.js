...
class Characterisation extends React.Component {
    ...
    handleSubmit(){
        let parameters = Object.assign({Type: "Characterisation"}, this.props.values);
        
        if (this._change()) {
            this.props.changeTask(this.state.clicked_task.parent_id, this.state.clicked_task.queue_id, this.state.clicked_task.sample_id, parameters);
