const validate = (values, props) => {
  ...
  if (!(parseInt(values.resolution, 10) > props.motorLimits.resolution.limits[0] &&
        parseInt(values.resolution, 10) < props.motorLimits.resolution.limits[1])) {
    errors.resolution = 'Resolution outside working range';
  }
  if (!(parseInt(values.energy, 10) > props.motorLimits.energy.limits[0] &&
        parseInt(values.energy, 10) < props.motorLimits.energy.limits[1])) {
