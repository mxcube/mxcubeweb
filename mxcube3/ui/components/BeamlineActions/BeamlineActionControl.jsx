...
import { MenuItem, Input, Button, ButtonToolbar, Glyphicon } from 'react-bootstrap';
...
export default class BeamlineActionControl extends React.Component {
  render() {
    ...
    return  (<ButtonToolbar>
        { this.props.arguments.length === 0 ? <Button bsSize="small" bsStyle={bsStyle} disabled={this.props.disabled}
