        ...
        <div className="sample-controlls">
            <div className="text-center"> 
                ...
                <button type="button" data-toggle="tooltip"  title="Backlight On/Off" className="btn btn-link pull-center light-button">
                    <i id="back-light-icon" className={"fa fa-2x fa-fw fa fa-lightbulb-o" + (this.props.sampleViewState.lightOn.back ? " light-on" : "")} onClick={this.toogleBackLight}></i>
                    <div id="back-light">
                ...
                <button type="button" data-toggle="tooltip"  title="Frontlight On/Off" className="btn btn-link pull-center light-button">
                    <i id="front-light-icon" className={"fa fa-2x fa-fw fa fa-lightbulb-o" + (this.props.sampleViewState.lightOn.front ? " light-on" : "")} onClick={this.toogleFrontLight}></i>
                    <div id="front-light">
